...
object DefaultClasses {
	...
	fun register() {
		Classes.registerClass(
			ClassInfo(ClipboardFormat::class.java, "clipboardformat")
		...
		Classes.registerClass(
			EnumClassInfo(BuiltInClipboardFormat::class.java, "builtinclipboardformat", "built in clipboard format")
	...
	internal object ClipboardFormatParser : Parser<ClipboardFormat>() {
